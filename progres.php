...
<body>
   ...
   <div class="dropdown">
    <a href="#" onclick="toggleDropdown(event)">Galery <i class="fas fa-chevron-down"></i></a>
    <div class="dropdown-content">
        <a href="galery.html">Desain 3D</a>
        <a href="progres.html">Progres</a>
        <a href="hasiljadi.html">Hasil Jadi</a>
        <a href="bast.html">BAST</a>
    </div>
   </div>
   ...
   <a href="login.html">
    ...
    <body>
        ...
        $progres = mysqli_query($conn, "SELECT * FROM progres");
        ?>
