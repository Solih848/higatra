...
<body>
            ...
            <div class="col-lg-10 col-md-11 mx-auto">
              <div class="detail-box">
                <div class="detail-text">
                  ...
                  <h1>
                    <b>HIGATRA PROPERTY</b>
                  </h1>
                  <h3>
                    <b>AHLINYA BANGUN BERGARANSI</b>
                  </h3>
                </div>
              </div>
            </div>
      ...
      <div class="row justify-content-center" style="margin-bottom: -100px;">
        ...
        while ($row = mysqli_fetch_assoc($result)): ?>
          <div class="col-6 col-sm-4 col-md-2 mb-5">
            <a href="detail-layanan.php?id=<?= $row['id']; ?>" class="service-link">
  ...
  <a href="https://wa.me/62887729791118?text=Halo,%20saya%20tertarik%20dengan%20jasa%20Anda." target="_blank" class="whatsapp-float">
